...
{
    public static HashSet<Vector2Int>
    SimpleRandomWalk(Vector2Int startPosition, int walkLength)
    {
        ...
        {
            var newPosition =
                previousPosition + Direction2D.GetRandomCardinalDirection();
...
public static class Direction2D
{
    ...
    {
        return cardinalDirectionsList[Random
            .Range(0, cardinalDirectionsList.Count)];
    }
}
